...
class CompletedFood extends StatefulWidget {
  const CompletedFood({Key? key}) : super(key: key);

  @override
  State<CompletedFood> createState() => _MainScreenState();
}

class _MainScreenState extends State<CompletedFood> {
  @override
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Text(data['totalamount'].toString(),style: TextStyle(
                                            fontSize: 17
                                        ),)
                                      ],
                                    )
